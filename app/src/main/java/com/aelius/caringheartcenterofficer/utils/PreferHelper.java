...
public class PreferHelper {
    ...
    private final String USER_ROAL = "userRole";
...
//		this.context = context;
    ...
    public String getUSER_ROAL() {
        return app_prefs.getString(USER_ROAL,null);
    }

    public void putUserRoal(String roal) {
        edit.putString(USER_ROAL, roal);
        edit.commit();
    }
